...
<div id="content-outer">
    <!-- start content -->
    <div id="content">
        <form method="get" action="addProduct_server.php" name="addProduct">
                                ...
                                <tr valign="top">
                                    <td>
                                        ...
                                        <div id="step-holder">
                                            ...
                                            <div class="step-dark-left"><a href="">添加监控商品</a></div>
                                            <div class="clear"></div>
                                        </div>
                                        <!--  end step-holder -->
                                        <!-- start id-form -->
                                        <table border="0" cellpadding="0" cellspacing="0" id="id-form">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" class="inp-form" name="user_price"/></td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                <th>&nbsp;</th>
                                                <td valign="top">
                                                    <input type="button" class="form-submit"
                                                           onclick="document.addProduct.submit();"/>
                                            ...
                                            <div id="related-act-bottom">
                                                ...
                                                <div id="related-act-inner">
                                                    ...
                                                    <div class="right">
                                                        ...
                                                        商品价格一旦低于预期价格，一封提醒邮件将会及时发送到您的邮箱！
                                                        <ul class="greyarrow">
                                                            <li><a href=""></a></li>
                                                        </ul>
                                                    </div>
...
<div id="footer">
    <!--  start footer-left -->
    <div id="footer-left">
        &copy; Copyright By ShaTong, Zhendong Yang. <span id="spanYear"></span>All rights reserved.
    </div>
    <!--  end footer-left -->
    <div class="clear">&nbsp;</div>
</div>
